...
/**
 * Used to add a tool-tip with the specified text to the left of the given
 * component.
 *
 * @author Micah Stairs
 * 
...
public class TooltipComponent extends JPanel {
    ...
    /**
     * This value is injected into the HTML by replacing occurrences of
     * 'TOOL_TIP_WIDTH' text with the number,
     ...
     * @param tooltipText The text to be displayed in the tool-tip (if {@code null},
     *                    then the '?' button will be hidden)
     **/
