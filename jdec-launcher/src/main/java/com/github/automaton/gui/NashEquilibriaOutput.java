...
public class NashEquilibriaOutput extends JDialog {
     ...
     * 
     * @param gui            A reference to the GUI which will be receiving requests
     *                       for new tabs
     ...
     *                       the screen
     **/
    public NashEquilibriaOutput(JDec gui, UStructure uStructure,
            java.util.List<Set<NashCommunicationData>> nashEquilibria, String title, String message) {
