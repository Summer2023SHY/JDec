  ...
  private void addMenuItem(JMenu menu, String str) {
    ...
    switch (str) {
      ...
      case "Subset Construction":
        menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, shortcutKey | InputEvent.SHIFT_DOWN_MASK));
        break;
      
      case "Relabel States":
        menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, shortcutKey | InputEvent.SHIFT_DOWN_MASK));
        break;
      ...
      case "Synchronized Composition":
...

        {
          ...
          Thread synchronizedCompositionThread = new Thread(
            ...
            FilenameUtils.removeExtension(tab.ioAdapter.getFile().getName()) + " - Synchronized composition"
          );
