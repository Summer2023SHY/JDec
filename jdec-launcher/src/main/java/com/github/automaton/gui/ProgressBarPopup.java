...
public class ProgressBarPopup extends JDialog {
     ...
     * @param nTasks The total number of tasks that need to be completed (which are
     *               all treated with an equal weight)
     **/
     ...
     * 
     * @param nCompletedTasks The updated number of how many tasks have been
     *                        completed
     **/
    ...
    private void setGUIproperties(String title) {
        ...
        // NOTE: If we did not do this, then we would have to make sure that the thread
        // governing
        // the process that is being executed is killed (which is not managed by this
        // class)
