    ...
    public void actionPerformed(ActionEvent event) {
        ...
        switch (event.getActionCommand()) {
            ...
            case "Synchronized Composition":
                ...
                Automaton automaton = tab.automaton.synchronizedComposition();
                if (automaton == null)
                    JOptionPane.showMessageDialog(null, "Please ensure that you specified a starting state.", "Synchronized Composition Failed", JOptionPane.ERROR_MESSAGE);
                else
