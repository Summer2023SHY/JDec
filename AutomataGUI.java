  ...
  public void actionPerformed(ActionEvent event) {
    ...
    switch (event.getActionCommand()) {
      ...
      case "Generate All":
        ...
        if (tab.automaton.getPotentialCommunications().size() == 0)
          JOptionPane.showMessageDialog(null, "The automaton needs to have at least 1 potential communication. Please ensure that you have added communications to the automaton.", "Operation Failed", JOptionPane.ERROR_MESSAGE);
        else
