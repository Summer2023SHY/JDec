...
/**
 * An iterable of system components that favor plants over specifications.
 * 
 * @author Sung Ho Yoon
 * @since 2.1.0
 */
public class PlantOverSpecComponentIterable extends ComponentIterable {
    ...
    /**
     * Constructs a new {@code PlantOverSpecComponentIterable}.
     * 
